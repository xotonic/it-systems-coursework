...
( sw_models.name like ('%' || $1 || '%') or sw_producers.name like ('%' || $1 || '%') );
--order by producer asc, name asc;
end;
 $_$;
...
where
sw_models.id_producer = sw_producers.id and
sw_objects.id_model = sw_models.id;
--order by producer asc, name asc;
end;
 $$;
...
INSERT INTO orders VALUES (1, '2016-06-16', NULL, 1, 'Max-Burger', 'Студяга 23');
...
INSERT INTO pc_objects VALUES (1, 0, 4000, false, '2016-06-16', NULL);
...
INSERT INTO sw_models VALUES (6, 5, '3ds Max');
INSERT INTO sw_models VALUES (7, 2, 'Photoshop CS3');
INSERT INTO sw_models VALUES (8, 6, 'ReSharper Ultimate');
...
INSERT INTO sw_objects VALUES (3, 6, 29999, false, NULL, NULL);
INSERT INTO sw_objects VALUES (4, 8, 40000, false, NULL, NULL);
INSERT INTO sw_objects VALUES (1, 7, 2999, false, '2016-06-16', NULL);
...
INSERT INTO sw_producers VALUES (5, 'Autodesk');
INSERT INTO sw_producers VALUES (6, 'JetBrains');
